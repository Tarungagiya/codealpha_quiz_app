...
public class NormalLevel extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        quizLists.addAll(QuizData.getNormalLevelQuizList());
        ...
        new CountDownTimer(50000,1000){
            ...
            public void onFinish() {
                Toast.makeText(NormalLevel.this, "Time out", Toast.LENGTH_SHORT).show();
        ...
        cardview1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (ansIs){
                    ...
                    currectAns++;
                    Toast.makeText(NormalLevel.this, "Answer is right", Toast.LENGTH_SHORT).show();
                }else {
                    opt1Ans.setBackgroundColor(Color.RED);
                    opt1_Ans.setBackgroundColor(Color.RED);
                    Toast.makeText(NormalLevel.this, "Answer is wrong", Toast.LENGTH_SHORT).show();
                }
