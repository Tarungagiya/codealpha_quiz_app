...
public class HardLevel extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        quizLists.addAll(QuizData.getHardLevelQuizList());
        ...
        new CountDownTimer(50000,1000){
            ...
            public void onFinish() {
                Toast.makeText(HardLevel.this, "Time out", Toast.LENGTH_SHORT).show();
        ...
        cardview1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (ansIs){
                    ...
                    currectAns++;
                    Toast.makeText(HardLevel.this, "Answer is right", Toast.LENGTH_SHORT).show();
                }else {
                    opt1Ans.setBackgroundColor(Color.RED);
                    opt1_Ans.setBackgroundColor(Color.RED);
                    Toast.makeText(HardLevel.this, "Answer is wrong", Toast.LENGTH_SHORT).show();
                }
